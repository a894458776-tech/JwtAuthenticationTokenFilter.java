...
public class AdminAccountStatSearchVO {
    ...
    @Generated
    public AdminAccountStatSearchVO() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminAccountStatSearchVO)) {
            return false;
        }
        AdminAccountStatSearchVO other = (AdminAccountStatSearchVO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AdminAccountStatSearchVO;
    }
    ...
    public String toString() {
        return "AdminAccountStatSearchVO(startTime=" + this.getStartTime() + ", endTime=" + this.getEndTime() + ", merchantId=" + this.getMerchantId() + ")";
    }
}
