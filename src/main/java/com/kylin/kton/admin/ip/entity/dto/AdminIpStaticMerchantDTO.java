...
public class AdminIpStaticMerchantDTO
extends KtonIpStaticMerchant {
    ...
    @Generated
    public AdminIpStaticMerchantDTO() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminIpStaticMerchantDTO)) {
            return false;
        }
        AdminIpStaticMerchantDTO other = (AdminIpStaticMerchantDTO)((Object)o);
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AdminIpStaticMerchantDTO;
    }
    ...
    public String toString() {
        return "AdminIpStaticMerchantDTO(id=" + this.getId() + ", poolId=" + this.getPoolId() + ", merchantId=" + this.getMerchantId() + ", account=" + this.getAccount() + ", password=" + this.getPassword() + ", port=" + this.getPort() + ", ip=" + this.getIp() + ", protocolse=" + this.getProtocolse() + ", isExclusive=" + this.getIsExclusive() + ", effectiveDatetime=" + this.getEffectiveDatetime() + ", expireDatetime=" + this.getExpireDatetime() + ", unsubscribeTime=" + this.getUnsubscribeTime() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", continent=" + this.getContinent() + ", countryCode=" + this.getCountryCode() + ", location=" + this.getLocation() + ", hot=" + this.getHot() + ", merchant=" + this.getMerchant() + ")";
    }
}
