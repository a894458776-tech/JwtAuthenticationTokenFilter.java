...
public class AdminMerchantInventoryIpsDTO
extends KtonIpStaticPool {
    ...
    @Generated
    public AdminMerchantInventoryIpsDTO() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminMerchantInventoryIpsDTO)) {
            return false;
        }
        AdminMerchantInventoryIpsDTO other = (AdminMerchantInventoryIpsDTO)((Object)o);
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AdminMerchantInventoryIpsDTO;
    }
    ...
    public String toString() {
        return "AdminMerchantInventoryIpsDTO(ipTotals=" + this.getIpTotals() + ", effectiveTotals=" + this.getEffectiveTotals() + ", configPlans=" + this.getConfigPlans() + ")";
    }
}
