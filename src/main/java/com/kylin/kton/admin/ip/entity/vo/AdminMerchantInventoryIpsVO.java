...
public class AdminMerchantInventoryIpsVO {
    private Long type;
    ...
    @Generated
    public AdminMerchantInventoryIpsVO() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminMerchantInventoryIpsVO)) {
            return false;
        }
        AdminMerchantInventoryIpsVO other = (AdminMerchantInventoryIpsVO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AdminMerchantInventoryIpsVO;
    }
    ...
    public String toString() {
        return "AdminMerchantInventoryIpsVO(type=" + this.getType() + ", sourceCode=" + this.getSourceCode() + ", sourceName=" + this.getSourceName() + ", continent=" + this.getContinent() + ", countryCode=" + this.getCountryCode() + ", location=" + this.getLocation() + ", hot=" + this.getHot() + ", status=" + this.getStatus() + ", merchantId=" + this.getMerchantId() + ", isExclusive=" + this.getIsExclusive() + ")";
    }
}
