...
public class AdminRegionalAvailableIpsVO {
    ...
    @Generated
    public AdminRegionalAvailableIpsVO() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminRegionalAvailableIpsVO)) {
            return false;
        }
        AdminRegionalAvailableIpsVO other = (AdminRegionalAvailableIpsVO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AdminRegionalAvailableIpsVO;
    }
    ...
    public String toString() {
        return "AdminRegionalAvailableIpsVO(merchantId=" + this.getMerchantId() + ", type=" + this.getType() + ", continents=" + this.getContinents() + ", countryCodes=" + this.getCountryCodes() + ", locations=" + this.getLocations() + ", ipFuzzyField=" + this.getIpFuzzyField() + ", isExclusive=" + this.getIsExclusive() + ")";
    }
}
