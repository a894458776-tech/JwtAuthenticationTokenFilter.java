...
public class PutOnIpSourceVO {
    @NotEmpty(message="\u5546\u6237Id\u4e0d\u80fd\u4e3a\u7a7a")
    @NotEmpty(message="\u5546\u6237Id\u4e0d\u80fd\u4e3a\u7a7a") List<Long> merchantIds;
    private Long poolId;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutOnIpSourceVO)) {
            return false;
        }
        PutOnIpSourceVO other = (PutOnIpSourceVO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PutOnIpSourceVO;
    }
    ...
    public String toString() {
        return "PutOnIpSourceVO(merchantIds=" + this.getMerchantIds() + ", poolId=" + this.getPoolId() + ", quantity=" + this.getQuantity() + ", specifyIpSwitch=" + this.getSpecifyIpSwitch() + ", ipListStr=" + this.getIpListStr() + ")";
    }
}
