...
public class AdminCountryNumsItemVO {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminCountryNumsItemVO)) {
            return false;
        }
        AdminCountryNumsItemVO other = (AdminCountryNumsItemVO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AdminCountryNumsItemVO;
    }
    ...
    public String toString() {
        return "AdminCountryNumsItemVO(continent=" + this.getContinent() + ", countryCode=" + this.getCountryCode() + ", location=" + this.getLocation() + ", num=" + this.getNum() + ", ipType=" + this.getIpType() + ")";
    }
}
