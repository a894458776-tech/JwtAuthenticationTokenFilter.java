...
public class AdminTicketAddVO {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminTicketAddVO)) {
            return false;
        }
        AdminTicketAddVO other = (AdminTicketAddVO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AdminTicketAddVO;
    }
    ...
    public String toString() {
        return "AdminTicketAddVO(merchantId=" + this.getMerchantId() + ", ticketType=" + this.getTicketType() + ", ticketTitle=" + this.getTicketTitle() + ", status=" + this.getStatus() + ", description=" + this.getDescription() + ", businessType=" + this.getBusinessType() + ", businessId=" + this.getBusinessId() + ")";
    }
}
