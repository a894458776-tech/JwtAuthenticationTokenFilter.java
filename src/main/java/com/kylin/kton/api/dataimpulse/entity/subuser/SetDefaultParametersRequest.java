...
public class SetDefaultParametersRequest
implements Serializable {
    ...
    @Generated
    public SetDefaultParametersRequest() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SetDefaultParametersRequest)) {
            return false;
        }
        SetDefaultParametersRequest other = (SetDefaultParametersRequest)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SetDefaultParametersRequest;
    }
    ...
    public String toString() {
        return "SetDefaultParametersRequest(subUserId=" + this.getSubUserId() + ", defaultPoolParameters=" + this.getDefaultPoolParameters() + ")";
    }
}
