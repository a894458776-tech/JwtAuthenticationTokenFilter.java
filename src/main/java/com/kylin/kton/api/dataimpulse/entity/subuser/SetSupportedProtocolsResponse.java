...
public class SetSupportedProtocolsResponse
implements Serializable {
    @JsonProperty(value="supported_protocols")
    private List<String> supportedProtocols;

    @Generated
    public SetSupportedProtocolsResponse() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SetSupportedProtocolsResponse)) {
            return false;
        }
        SetSupportedProtocolsResponse other = (SetSupportedProtocolsResponse)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SetSupportedProtocolsResponse;
    }
    ...
    public String toString() {
        return "SetSupportedProtocolsResponse(supportedProtocols=" + this.getSupportedProtocols() + ")";
    }
}
