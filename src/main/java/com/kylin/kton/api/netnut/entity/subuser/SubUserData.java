...
import com.kylin.kton.api.netnut.entity.subuser.SubUserPlans;
...
public class SubUserData {
    ...
    private List<SubUserPlans> plans;
    ...
    @Generated
    public List<SubUserPlans> getPlans() {
        return this.plans;
    }
    ...
    @JsonProperty(value="plans")
    @Generated
    public void setPlans(List<SubUserPlans> plans) {
        this.plans = plans;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SubUserData)) {
            return false;
        }
        SubUserData other = (SubUserData)o;
        ...
        List<SubUserPlans> this$plans = this.getPlans();
        List<SubUserPlans> other$plans = other.getPlans();
        return !(this$plans == null ? other$plans != null : !((Object)this$plans).equals(other$plans));
    }

    @Generated
    protected boolean canEqual(Object other) {
        return other instanceof SubUserData;
    }
    ...
    public int hashCode() {
        int PRIME = 59;
        int result = 1;
        result = result * 59 + this.getCustomerId();
        ...
        List<SubUserPlans> $plans = this.getPlans();
    ...
    public String toString() {
        return "SubUserData(customerId=" + this.getCustomerId() + ", customerName=" + this.getCustomerName() + ", customerLoginName=" + this.getCustomerLoginName() + ", customerDashboardEmail=" + this.getCustomerDashboardEmail() + ", customerActive=" + this.isCustomerActive() + ", plans=" + this.getPlans() + ")";
    }
}
