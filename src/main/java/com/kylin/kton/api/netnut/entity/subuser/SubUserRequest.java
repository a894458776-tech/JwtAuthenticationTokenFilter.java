...
public class SubUserRequest {
    ...
    public boolean equals(Object o) {
        ...
        return !(this$customerLoginPwd == null ? other$customerLoginPwd != null : !this$customerLoginPwd.equals(other$customerLoginPwd));
    }
    ...
    public String toString() {
        return "SubUserRequest(customerDashboardEmail=" + this.getCustomerDashboardEmail() + ", customerName=" + this.getCustomerName() + ", customerLoginName=" + this.getCustomerLoginName() + ", customerLoginPwd=" + this.getCustomerLoginPwd() + ", planId=" + this.getPlanId() + ")";
    }
}
