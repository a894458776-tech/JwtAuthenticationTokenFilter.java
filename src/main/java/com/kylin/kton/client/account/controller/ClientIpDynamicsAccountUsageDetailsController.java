...
@RestController
@RequestMapping(value={"/client/dynamics/account/details"})
public class ClientIpDynamicsAccountUsageDetailsController
extends BaseController {
    @Autowired
    private ClientIpDynamicsAccountUsageDetailsService ktonIpDynamicsAccountUsageDetailsService;
