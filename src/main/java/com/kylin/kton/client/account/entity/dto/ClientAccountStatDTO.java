...
public class ClientAccountStatDTO {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClientAccountStatDTO)) {
            return false;
        }
        ClientAccountStatDTO other = (ClientAccountStatDTO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClientAccountStatDTO;
    }
    ...
    public String toString() {
        return "ClientAccountStatDTO(requestsTotal=" + this.getRequestsTotal() + ", trafficTotal=" + this.getTrafficTotal() + ", dUsage=" + this.getDUsage() + ")";
    }
}
