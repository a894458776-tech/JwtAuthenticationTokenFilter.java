...
public class AccountEditVO {
    ...
    public String toString() {
        return "AccountEditVO(id=" + this.getId() + ", trafficLimit=" + this.getTrafficLimit() + ", label=" + this.getLabel() + ", account=" + this.getAccount() + ", password=" + this.getPassword() + ", merchantId=" + this.getMerchantId() + ", accountId=" + this.getAccountId() + ", remarks=" + this.getRemarks() + ", sourceCode=" + this.getSourceCode() + ", protocols=" + this.getProtocols() + ")";
    }
}
