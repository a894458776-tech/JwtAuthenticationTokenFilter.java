...
public class AddDataimpulseAccountVO {
    ...
    @Generated
    public AddDataimpulseAccountVO() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddDataimpulseAccountVO)) {
            return false;
        }
        AddDataimpulseAccountVO other = (AddDataimpulseAccountVO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AddDataimpulseAccountVO;
    }
    ...
    public String toString() {
        return "AddDataimpulseAccountVO(trafficLimit=" + this.getTrafficLimit() + ", label=" + this.getLabel() + ", remarks=" + this.getRemarks() + ", merchantId=" + this.getMerchantId() + ", protocols=" + this.getProtocols() + ")";
    }
}
