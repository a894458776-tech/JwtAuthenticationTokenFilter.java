...
public class RegionalAvailableIpsDTO {
    private Long id;
    ...
    @Generated
    public RegionalAvailableIpsDTO() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RegionalAvailableIpsDTO)) {
            return false;
        }
        RegionalAvailableIpsDTO other = (RegionalAvailableIpsDTO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof RegionalAvailableIpsDTO;
    }
    ...
    public String toString() {
        return "RegionalAvailableIpsDTO(id=" + this.getId() + ", type=" + this.getType() + ", continent=" + this.getContinent() + ", countryCode=" + this.getCountryCode() + ", location=" + this.getLocation() + ", price=" + this.getPrice() + ", ipTotals=" + this.getIpTotals() + ")";
    }
}
