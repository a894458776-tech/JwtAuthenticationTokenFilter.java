...
public class ClientStaticPoolSearchVO {
    ...
    @Generated
    public ClientStaticPoolSearchVO() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClientStaticPoolSearchVO)) {
            return false;
        }
        ClientStaticPoolSearchVO other = (ClientStaticPoolSearchVO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClientStaticPoolSearchVO;
    }
    ...
    public String toString() {
        return "ClientStaticPoolSearchVO(continent=" + this.getContinent() + ", countryCode=" + this.getCountryCode() + ", type=" + this.getType() + ", location=" + this.getLocation() + ")";
    }
}
