...
public class IpStaticPoolItemSearchVO {
    private Long type;
    private String ip;
    ...
    @Generated
    public IpStaticPoolItemSearchVO() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IpStaticPoolItemSearchVO)) {
            return false;
        }
        IpStaticPoolItemSearchVO other = (IpStaticPoolItemSearchVO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof IpStaticPoolItemSearchVO;
    }
    ...
    public String toString() {
        return "IpStaticPoolItemSearchVO(type=" + this.getType() + ", ip=" + this.getIp() + ", status=" + this.getStatus() + ", orderNo=" + this.getOrderNo() + ", merchantId=" + this.getMerchantId() + ", countryCode=" + this.getCountryCode() + ")";
    }
}
