 ...
 *  lombok.Generated
 */
package com.kylin.kton.client.merchant.base.entity.dto;

import com.kylin.kton.system.domain.KtonSource;
import lombok.Generated;

public class ClientMerchantSourceDTO
extends KtonSource {
    ...
    @Generated
    public ClientMerchantSourceDTO() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClientMerchantSourceDTO)) {
            return false;
        }
        ClientMerchantSourceDTO other = (ClientMerchantSourceDTO)((Object)o);
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClientMerchantSourceDTO;
    }
    ...
    public String toString() {
        return "ClientMerchantSourceDTO(merchantId=" + this.getMerchantId() + ", ipType=" + this.getIpType() + ", sourceId=" + this.getSourceId() + ", weight=" + this.getWeight() + ", sourceCode=" + this.getSourceCode() + ")";
    }
}
