...
public class UnsubscribeStaticIpVO {
    private List<String> ipList;
    private Long merchantId;

    @Generated
    public UnsubscribeStaticIpVO() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UnsubscribeStaticIpVO)) {
            return false;
        }
        UnsubscribeStaticIpVO other = (UnsubscribeStaticIpVO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof UnsubscribeStaticIpVO;
    }
    ...
    public String toString() {
        return "UnsubscribeStaticIpVO(ipList=" + this.getIpList() + ", merchantId=" + this.getMerchantId() + ")";
    }
}
