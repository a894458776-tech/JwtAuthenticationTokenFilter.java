...
public class ClientTicketAddVO {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClientTicketAddVO)) {
            return false;
        }
        ClientTicketAddVO other = (ClientTicketAddVO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClientTicketAddVO;
    }
    ...
    public String toString() {
        return "ClientTicketAddVO(merchantId=" + this.getMerchantId() + ", ticketType=" + this.getTicketType() + ", ticketTitle=" + this.getTicketTitle() + ", description=" + this.getDescription() + ", businessType=" + this.getBusinessType() + ", businessId=" + this.getBusinessId() + ")";
    }
}
