 ...
 *  lombok.Generated
 */
package com.kylin.kton.client.ticket.entity.vo;

import javax.validation.constraints.NotNull;
import lombok.Generated;

public class ClientTicketEditVO {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClientTicketEditVO)) {
            return false;
        }
        ClientTicketEditVO other = (ClientTicketEditVO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClientTicketEditVO;
    }
    ...
    public String toString() {
        return "ClientTicketEditVO(id=" + this.getId() + ", merchantId=" + this.getMerchantId() + ", ticketType=" + this.getTicketType() + ", ticketTitle=" + this.getTicketTitle() + ", description=" + this.getDescription() + ", businessType=" + this.getBusinessType() + ", businessId=" + this.getBusinessId() + ")";
    }
}
