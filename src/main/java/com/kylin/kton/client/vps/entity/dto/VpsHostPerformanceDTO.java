...
public class VpsHostPerformanceDTO {
    private Long id;
    private Long hostId;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VpsHostPerformanceDTO)) {
            return false;
        }
        VpsHostPerformanceDTO other = (VpsHostPerformanceDTO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof VpsHostPerformanceDTO;
    }
    ...
    public String toString() {
        return "VpsHostPerformanceDTO(id=" + this.getId() + ", hostId=" + this.getHostId() + ", model=" + this.getModel() + ", cpuCores=" + this.getCpuCores() + ", cpuModel=" + this.getCpuModel() + ", memory=" + this.getMemory() + ", diskCapacity=" + this.getDiskCapacity() + ", diskModel=" + this.getDiskModel() + ", ioWrite=" + this.getIoWrite() + ", ioRead=" + this.getIoRead() + ", bandwidth=" + this.getBandwidth() + ", internetTraffic=" + this.getInternetTraffic() + ", ipV4=" + this.getIpV4() + ", ipV6=" + this.getIpV6() + ", priceMonthly=" + this.getPriceMonthly() + ", priceQuarterly=" + this.getPriceQuarterly() + ", priceSemiAnnually=" + this.getPriceSemiAnnually() + ", priceAnnually=" + this.getPriceAnnually() + ")";
    }
}
