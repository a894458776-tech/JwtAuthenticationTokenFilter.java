...
public class HostListSearchVO {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HostListSearchVO)) {
            return false;
        }
        HostListSearchVO other = (HostListSearchVO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof HostListSearchVO;
    }
    ...
    public String toString() {
        return "HostListSearchVO(hostIp=" + this.getHostIp() + ", continent=" + this.getContinent() + ", countryCode=" + this.getCountryCode() + ", city=" + this.getCity() + ", sshPort=" + this.getSshPort() + ")";
    }
}
