 ...
 */
package com.kylin.kton.common.core.text;

import com.kylin.kton.common.core.text.CharsetKit;
...
public class Convert {
    ...
    public static String digitUppercase(double n) {
        ...
        for (int i = 0; i < fraction.length; ++i) {
            ...
            s = s + (digit[(int)(Math.floor(d * Math.pow(10.0, i)) % 10.0)] + fraction[i]).replaceAll("(\u96f6.)+", "");
        }
        if (s.length() < 1) {
            s = "\u6574";
        }
