 ...
 *  com.kylin.kton.common.utils.Arith
 *  com.kylin.kton.common.utils.DateUtils
 */
package com.kylin.kton.framework.web.domain.server;
...
public class Jvm {
    ...
    public String getRunTime() {
        return DateUtils.timeDistance((Date)DateUtils.getNowDate(), (Date)DateUtils.getServerStartDate());
    }
